...
page 50004 ItemDepreciationCard
{
    ApplicationArea = All;
    Caption = 'ESD-Fixed Asset Card';
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(ItemDepreciationCardSubform; "Item Depreciation Card Subform")
            {
                ApplicationArea = All;
                SubPageLink = "Source No." = field("Item No.");
            }
        }
    }
    actions
        ...
        area(Processing)
        {
            action(CalculateDepreciation)
            {
                ...
                begin
                    ...
                    CalculateDepreciationReport.SetSourcePage(Page::ItemDepreciationCard);
